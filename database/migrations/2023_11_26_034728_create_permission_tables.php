...
return new class () extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create(
            ...
            function (Blueprint $table) use ($tableNames, $columnNames, $pivotPermission, $teams): void {
        ...
        Schema::create(
            ...
            function (Blueprint $table) use ($tableNames, $columnNames, $pivotRole, $teams): void {
        ...
        Schema::create(
            ...
            function (Blueprint $table) use ($tableNames, $pivotRole, $pivotPermission): void {
                $table->unsignedBigInteger($pivotPermission);
                $table->unsignedBigInteger($pivotRole);
