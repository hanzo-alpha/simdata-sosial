...
namespace App\Filament\Resources\BantuanRastraResource\RelationManagers;
        ...
        return $table
            ...
            ->recordActions([
                ...
                Action::make('pdf')
                    ...
                    ->url(fn(Model $record) => route('cetak-dokumentasi.rastra', ['id' => $record, 'm' => get_class($record)]))
                    ->openUrlInNewTab(),
            ])
            ->toolbarActions([
