...
class BantuanPkhChart extends ApexChartWidget
{
    use HasWidgetShield;
     ...
     * @var string
     */
    protected static string $chartId = 'Bantuan PKH';
     ...
     * @var string|null
     */
    protected static ?string $heading = 'Penerima Manfaat Bantuan PKH';
