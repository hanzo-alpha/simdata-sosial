...
class TipePpksPolicy
{
    ...
    {
        return $user->can('delete_any_tipe::ppks');
    }
    ...
    {
        return $user->can('force_delete_any_tipe::ppks');
    }
    ...
    {
        return $user->can('restore_any_tipe::ppks');
    }
    ...
    {
        return $user->can('download_tipe::ppks');
    }

    public function upload(User $user): bool
    {
        return $user->can('upload_tipe::ppks');
    }

    public function verifyStatus(User $user): bool
    {
        return $user->can('verify_status_tipe::ppks');
    }


    public function verification(User $user): bool
    {
        return $user->can('verification_tipe::ppks');
    }
}
