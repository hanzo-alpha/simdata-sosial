...
class PenyaluranBantuanPpksPolicy
{
    ...
    {
        return $user->can('download_penyaluran::bantuan::ppks');
    }

    public function upload(User $user): bool
    {
        return $user->can('upload_penyaluran::bantuan::ppks');
    }

    public function verifyStatus(User $user): bool
    {
        return $user->can('verify_status_penyaluran::bantuan::ppks');
    }


    public function verification(User $user): bool
    {
        return $user->can('verification_penyaluran::bantuan::ppks');
    }
}
