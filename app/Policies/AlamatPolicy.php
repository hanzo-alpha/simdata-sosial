...
final class AlamatPolicy
{
    ...
    {
        return $user->can('view_any_alamat');
    }
    ...
    {
        return $user->can('force_delete_alamat');
    }
     ...
     */
    public function replicate(User $user, Alamat $alamat): bool
    {
