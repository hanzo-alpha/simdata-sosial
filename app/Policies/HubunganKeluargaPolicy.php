...
class HubunganKeluargaPolicy
{
    ...
    {
        return $user->can('view_any_hubungan::keluarga');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\HubunganKeluarga  $hubunganKeluarga
     * @return bool
     */
    public function view(User $user, HubunganKeluarga $hubunganKeluarga): bool
    {
        return $user->can('view_hubungan::keluarga');
    }
    ...
    {
        return $user->can('create_hubungan::keluarga');
    }
    ...
    {
        return $user->can('update_hubungan::keluarga');
    }
    ...
    {
        return $user->can('delete_hubungan::keluarga');
    }
    ...
    {
        return $user->can('force_delete_hubungan::keluarga');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, HubunganKeluarga $hubunganKeluarga): bool
    {
