...
class BantuanPkhBpntPolicy
{
    ...
    {
        return $user->can('view_any_bantuan::pkh::bpnt');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\BantuanPkhBpnt  $bantuanPkhBpnt
     * @return bool
     */
    public function view(User $user, BantuanPkhBpnt $bantuanPkhBpnt): bool
    {
        return $user->can('view_bantuan::pkh::bpnt');
    }
    ...
    {
        return $user->can('create_bantuan::pkh::bpnt');
    }
    ...
    {
        return $user->can('update_bantuan::pkh::bpnt');
    }
    ...
    {
        return $user->can('delete_bantuan::pkh::bpnt');
    }
    ...
    {
        return $user->can('force_delete_bantuan::pkh::bpnt');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, BantuanPkhBpnt $bantuanPkhBpnt): bool
    {
