...
class BantuanPolicy
{
    ...
    {
        return $user->can('view_any_bantuan');
    }
    ...
    {
        return $user->can('create_bantuan');
    }
    ...
    {
        return $user->can('update_bantuan');
    }
    ...
    {
        return $user->can('delete_bantuan');
    }
    ...
    {
        return $user->can('force_delete_bantuan');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, Bantuan $bantuan): bool
    {
