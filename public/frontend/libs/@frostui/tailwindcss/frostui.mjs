...
function Ht(e, i, t) {
    ...
    const a = s.x + s.width / 2 - n.width / 2, l = s.y + s.height / 2 - n.height / 2, r = ut(i), d = Rt(r),
        h = s[d] / 2 - n[d] / 2, f = r === "x";
    let c;
    switch (st(i)) {
        case "top":
...
const ce = async (e, i, t) => {
    const {placement: s = "bottom", strategy: n = "absolute", middleware: a = [], platform: l} = t,
        r = a.filter(Boolean), d = await (l.isRTL == null ? void 0 : l.isRTL(i));
    let h = await l.getElementRects({reference: e, floating: i, strategy: n}), {x: f, y: c} = Ht(h, s, d), m = s,
        g = {}, E = 0;
    for (let u = 0; u < r.length; u++) {
        const {name: L, fn: w} = r[u], {x: y, y: b, data: D, reset: k} = await w({
            x: f,
            y: c,
            initialPlacement: s,
            placement: m,
        ...
        f = y ?? f, c = b ?? c, g = {
            ...g,
            [L]: {...g[L], ...D}
        }, k && E <= 50 && (E++, typeof k == "object" && (k.placement && (m = k.placement), k.rects && (h = k.rects === !0 ? await l.getElementRects({
            reference: e,
            floating: i,
            strategy: n
        }) : k.rects), {x: f, y: c} = Ht(h, m, d)), u = -1);
    }
...
async function zt(e, i) {
    var t;
    i === void 0 && (i = {});
    const {x: s, y: n, platform: a, rects: l, elements: r, strategy: d} = e, {
            boundary: h = "clippingAncestors",
            rootBoundary: f = "viewport",
            elementContext: c = "floating",
            altBoundary: m = !1,
            padding: g = 0
        } = i, E = qt(g), u = r[m ? c === "floating" ? "reference" : "floating" : c], L = yt(await a.getClippingRect({
            element: (t = await (a.isElement == null ? void 0 : a.isElement(u))) == null || t ? u : u.contextElement || await (a.getDocumentElement == null ? void 0 : a.getDocumentElement(r.floating)),
            boundary: h,
            rootBoundary: f,
            strategy: d
        })), w = c === "floating" ? {...l.floating, x: s, y: n} : l.reference,
        y = await (a.getOffsetParent == null ? void 0 : a.getOffsetParent(r.floating)),
        b = await (a.isElement == null ? void 0 : a.isElement(y)) && await (a.getScale == null ? void 0 : a.getScale(y)) || {
            x: 1,
            y: 1
        },
        D = yt(a.convertOffsetParentRelativeRectToViewportRelativeRect ? await a.convertOffsetParentRelativeRectToViewportRelativeRect({
            rect: w,
            offsetParent: y,
            strategy: d
        }) : w);
    return {
        top: (L.top - D.top + E.top) / b.y,
        bottom: (D.bottom - L.bottom + E.bottom) / b.y,
        left: (L.left - D.left + E.left) / b.x,
        right: (D.right - L.right + E.right) / b.x
    };
}
...
const fe = (e) => ({
    name: "arrow", options: e, async fn(i) {
        const {element: t, padding: s = 0} = e || {}, {
            x: n,
            y: a,
            placement: l,
            rects: r,
        ...
        if (t == null)
            return {};
        const f = qt(s), c = {x: n, y: a}, m = ut(l), g = Rt(m), E = await d.getDimensions(t), u = m === "y",
            L = u ? "top" : "left", w = u ? "bottom" : "right", y = u ? "clientHeight" : "clientWidth",
            b = r.reference[g] + r.reference[m] - c[m] - r.floating[g], D = c[m] - r.reference[m],
            k = await (d.getOffsetParent == null ? void 0 : d.getOffsetParent(t));
        let H = k ? k[y] : 0;
        H && await (d.isElement == null ? void 0 : d.isElement(k)) || (H = h.floating[y] || r.floating[g]);
        const Y = b / 2 - D / 2, G = f[L], ot = H - E[g] - f[w], V = H / 2 - E[g] / 2 + Y, A = Ut(G, V, ot),
            R = gt(l) != null && V != A && r.reference[g] / 2 - (V < G ? f[L] : f[w]) - E[g] / 2 < 0;
...
const pe = function (e) {
    return e === void 0 && (e = {}), {
        name: "flip", options: e, async fn(i) {
            var t;
            const {
                    placement: s,
                    middlewareData: n,
                    ...
                    flipAlignment: E = !0,
                    ...u
                } = e, L = st(s), w = st(l) === l, y = await (r.isRTL == null ? void 0 : r.isRTL(d.floating)),
                b = c || (w || !E ? [wt(l)] : function (A) {
                    const R = wt(A);
                    return [Dt(A), R, Dt(R)];
                }(l));
            c || g === "none" || b.push(...function (A, R, Q, B) {
                ...
                let O = function (ct, kt, ne) {
                    const $t = ["left", "right"], It = ["right", "left"], le = ["top", "bottom"],
                        ae = ["bottom", "top"];
                    switch (ct) {
                        case "top":
                        case "bottom":
    ...
    return e === void 0 && (e = 0), {
        name: "offset", options: e, async fn(i) {
            const {x: t, y: s} = i, n = await async function (a, l) {
                const {placement: r, platform: d, elements: h} = a,
                    f = await (d.isRTL == null ? void 0 : d.isRTL(h.floating)), c = st(r), m = gt(r), g = ut(r) === "x",
                    E = ["left", "top"].includes(c) ? -1 : 1, u = f && g ? -1 : 1,
                    L = typeof l == "function" ? l(a) : l;
                let {mainAxis: w, crossAxis: y, alignmentAxis: b} = typeof L == "number" ? {
                    mainAxis: L,
                    crossAxis: 0,
                    alignmentAxis: null
                } : {mainAxis: 0, crossAxis: 0, alignmentAxis: null, ...L};
                return m && typeof b == "number" && (y = m === "end" ? -1 * b : b), g ? {
                    x: y * u,
                    y: w * E
                } : {x: w * E, y: y * u};
            }(i, e);
...
const ye = function (e) {
    return e === void 0 && (e = {}), {
        name: "shift", options: e, async fn(i) {
            const {x: t, y: s, placement: n} = i, {
                mainAxis: a = !0, crossAxis: l = !1, limiter: r = {
                    fn: (L) => {
                        let {x: w, y} = L;
                        return {x: w, y};
                    }
                }, ...d
            } = e, h = {x: t, y: s}, f = await zt(i, d), c = ut(st(n)), m = Le(c);
            let g = h[c], E = h[m];
            if (a) {
...
function ft(e, i, t, s) {
    ...
    let c = (l.left + (f && ((n = h.visualViewport) == null ? void 0 : n.offsetLeft) || 0)) / d.x,
        m = (l.top + (f && ((a = h.visualViewport) == null ? void 0 : a.offsetTop) || 0)) / d.y, g = l.width / d.x,
        E = l.height / d.y;
    if (r) {
...
function At(e) {
    return J(e) ? {scrollLeft: e.scrollLeft, scrollTop: e.scrollTop} : {
...
function Pt(e, i, t) {
    ...
    if (i === "viewport")
        ...
        s = function (l) {
            const r = K(l), d = At(l), h = l.ownerDocument.body,
                f = dt(r.scrollWidth, r.clientWidth, h.scrollWidth, h.clientWidth),
                c = dt(r.scrollHeight, r.clientHeight, h.scrollHeight, h.clientHeight);
            let m = -d.scrollLeft + Zt(l);
            const g = -d.scrollTop;
            return $(h).direction === "rtl" && (m += dt(r.clientWidth, h.clientWidth) - f), {
                width: f,
                height: c,
                x: m,
                y: g
        ...
        s = function (l, r) {
            const d = ft(l, !0, r === "fixed"), h = d.top + l.clientTop, f = d.left + l.clientLeft,
                c = N(l) ? rt(l) : {x: 1, y: 1};
...
const Vt = class extends I {
    ...
    showTab(t) {
        const s = this._elements.get(t), n = Array.from(this._elements.keys()).filter((l) => l != t),
            a = n.map((l) => this._elements.get(l));
    ...
    computeTooltipPosition() {
        ...
        this._arrowElement && t.push(fe({element: this._arrowElement})), this._element != null && this._targetElement != null && (this._targetElement.classList.add(v.DEFAULT.class.absolute), this._arrowElement && this._arrowElement.classList.add(v.DEFAULT.class.absolute), ie(this._element, this._targetElement, {
            ...
            if (Object.assign(this._targetElement.style, {
                ...
                const {x: f, y: c} = a.arrow, m = f != null ? `${f}px` : `${-this._arrowElement.offsetWidth / 2}px`,
                    g = c != null ? `${c}px` : `${-this._arrowElement.offsetHeight / 2}px`, E = {
